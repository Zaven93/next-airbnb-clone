...
const Layout = (props) => {
  ...
  return (
    <div>
      ...
      {showModal && (
        <Modal close={(e) => setHideModal()}>
          {showLoginModal && <LoginModal showSignup={() => setShowRegistrationModal()} />}
          {showRegistrationModal && <RegistrationModal showLogin={() => setShowLoginModal()} />}
        </Modal>
      )}
      <style jsx global>
        {`
